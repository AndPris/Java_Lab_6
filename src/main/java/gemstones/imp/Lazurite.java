...
/**
 * The <code>gemstones.imp.Lazurite</code> class represents a specific type of semi-precious gemstone, gemstones.imp.Lazurite.
 * It extends the {@link SemiPreciousGemstone} class, inheriting the attributes and behavior for weight, price, and transparency.
 */
public class Lazurite extends SemiPreciousGemstone {
    /**
     * Constructs a new <code>gemstones.imp.Lazurite</code> gemstone with the specified weight, price, and transparency.
     *
     ...
     */
    public Lazurite(double weight, double price, double transparency) {
